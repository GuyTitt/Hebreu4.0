...
STRUCTURE = {
    ...
    "fichiers": [
        {
            ...
            "nom_affiché": "verbe ע״גּ׳ et ל״א quiescent : le seul verbe מָחָא",
            "nom_TDM": "{{nom_affiché}}",
        ...
        },
        {
            ...
            "nom_affiché": "Verbe ע״גּ׳ et ל״ה (avec 2<sup>ème</sup> Gutturale ע) Modèle תָּעָה",
            "nom_TDM": "{{nom_affiché}}",
            "ajout_affichage": True,
            "affiché_index": True,
            "affiché_TDM": True,
        ...
        },
        {
            ...
            "nom_affiché": "Verbe ע״גּ׳ et ל״ה (avec 2<sup>ème</sup> Gutturale א) Modèle לָאָה",
            "nom_TDM": "{{nom_affiché}}",
            "ajout_affichage": True,
            "affiché_index": True,
            "affiché_TDM": True,
        ...
        },
        {
            ...
            "nom_affiché": "Verbe ע״גּ׳ et ל״ה (avec 2<sup>ème</sup> Gutturale ה) Modèle כָּהָה",
            "nom_TDM": "{{nom_affiché}}",
            "ajout_affichage": True,
            "affiché_index": True,
            "affiché_TDM": True,
        ...
        },
        {
            ...
            "nom_affiché": "Verbe ע״גּ׳ et ל״ה (avec 2<sup>ème</sup> Gutturale ח) Modèle מָחָה",
            "nom_TDM": "{{nom_affiché}}",
            "ajout_affichage": True,
            "affiché_index": True,
            "affiché_TDM": True,
        ...
        },
        {
            ...
            "nom_affiché": "►Verbe ע״ר et ל״גּ׳ Modèle קָרַע",
            "nom_TDM": "{{nom_affiché}}",
            "ajout_affichage": True,
            "affiché_index": True,
            "affiché_TDM": True,
        ...
        },
        {
            ...
            "nom_affiché": "►Verbe ע״ר et ל״א (quiescent) Modèle קָרָא",
            "nom_TDM": "{{nom_affiché}}",
            "ajout_affichage": True,
            "affiché_index": True,
            "affiché_TDM": True,
        ...
        },
        {
            ...
            "nom_affiché": "►Verbe ע״ר et ל״ה (quiescent) Modèle קָרָה",
            "nom_TDM": "{{nom_affiché}}",
            "ajout_affichage": True,
            "affiché_index": True,
            "affiché_TDM": True,
        ...
        },
        {
            ...
            "nom_affiché": "►Verbes ע״ו ou ע״י et ל״גּ׳ Modèles פּוּחַ et שִׂיחַ",
            "nom_TDM": "{{nom_affiché}}",
            "ajout_affichage": True,
            "affiché_index": True,
            "affiché_TDM": True,
        ...
        },
        {
            ...
            "nom_affiché": "Verbes ע״ו ou ע״י et ל״א = les seuls verbes נוּא et קִיא",
            "nom_TDM": "{{nom_affiché}}",
            "ajout_affichage": True,
            "affiché_index": True,
            "affiché_TDM": True,
        ...
        },
        {
            ...
            "nom_affiché": "Verbes ע״ע (avec ע = גּ׳) Modèles לָעַע et שָׁחַח",
            "nom_TDM": "{{nom_affiché}}",
            "ajout_affichage": True,
            "affiché_index": True,
            "affiché_TDM": True,
        ...
        },
        {
            ...
            "nom_affiché": "Verbes ע״ע (avec ע = ר) Modèles פָּרַר et צָרַר",
            "nom_TDM": "{{nom_affiché}}",
            "ajout_affichage": True,
            "affiché_index": True,
            "affiché_TDM": True,
    ...
    "titre_dossier": "Verbes avec 1<sup>ère</sup> Shalem",
    "entete_general": True,
    "pied_general": True,
    "entete": True,
    "pied": True,
