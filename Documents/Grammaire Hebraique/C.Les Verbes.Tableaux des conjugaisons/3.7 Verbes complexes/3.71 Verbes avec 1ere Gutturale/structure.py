...
STRUCTURE = {
    ...
    "fichiers": [
        {
            ...
            "nom_affiché": "Verbe פ״גּ׳ et ל״גּ׳ Modèle אָנַח",
            "nom_TDM": "{{nom_affiché}}",
        ...
        },
        {
            ...
            "nom_affiché": "►Verbe פ״גּ׳ et ל״א Modèles חָטָא et חָבָא",
            "nom_TDM": "{{nom_affiché}}",
            "ajout_affichage": True,
            "affiché_index": True,
            "affiché_TDM": True,
        ...
        },
        {
            ...
            "nom_affiché": "►Verbe פ״גּ׳ et ל״ה. Les 4 (ou 5) variantes du binyan Pa'al (I)",
            "nom_TDM": "{{nom_affiché}}",
            "ajout_affichage": True,
            "affiché_index": True,
            "affiché_TDM": True,
        ...
        },
        {
            ...
            "nom_affiché": "►Verbe פ״גּ׳ et ל״ה Modèle עָשָׂה simplifié",
            "nom_TDM": "{{nom_affiché}}",
            "ajout_affichage": True,
            "affiché_index": True,
            "affiché_TDM": True,
        ...
        },
        {
            ...
            "nom_affiché": "Verbe פ״גּ׳ et ל״ה Modèle עָשָׂה détaillé. (Binyanîm qallîm)",
            "nom_TDM": "{{nom_affiché}}",
            "ajout_affichage": True,
            "affiché_index": True,
            "affiché_TDM": True,
        ...
        },
        {
            ...
            "nom_affiché": "Verbe פ״גּ׳ et ל״ה Modèle עָשָׂה détaillé. (Binyanîm kevédîm et goremîm)",
            "nom_TDM": "{{nom_affiché}}",
            "ajout_affichage": True,
            "affiché_index": True,
            "affiché_TDM": True,
        ...
        },
        {
            ...
            "nom_affiché": "Verbes פ״גּ׳ et ל״ה (avec voyelle A) et shewa : les seuls verbes עָטָה ,עָדָה et חָתָה",
            "nom_TDM": "{{nom_affiché}}",
            "ajout_affichage": True,
            "affiché_index": True,
            "affiché_TDM": True,
        ...
        },
        {
            ...
            "nom_affiché": "Verbe פ״גּ׳ et ל״ה (avec voyelle È) et hataf Modèle הָמָה détaillé",
            "nom_TDM": "{{nom_affiché}}",
            "ajout_affichage": True,
            "affiché_index": True,
            "affiché_TDM": True,
        ...
        },
        {
            ...
            "nom_affiché": "Verbe פ״גּ׳ et ל״ה (avec voyelle È) et shewa Modèle הָגָה détaillé",
            "nom_TDM": "{{nom_affiché}}",
            "ajout_affichage": True,
            "affiché_index": True,
            "affiché_TDM": True,
        ...
        },
        {
            ...
            "nom_affiché": "Verbes פ״גּ׳ (avec ה = גּ׳ ou ע) et ע״ר et ל״ה = הָרָה et עָרָה",
            "nom_TDM": "{{nom_affiché}}",
            "ajout_affichage": True,
            "affiché_index": True,
            "affiché_TDM": True,
        ...
        },
        {
            ...
            "nom_affiché": "Verbes פ״גּ׳ (avec א = גּ׳ ou ח) et ע״ר et ל״ה = אָרָה et חָרָה",
            "nom_TDM": "{{nom_affiché}}",
            "ajout_affichage": True,
            "affiché_index": True,
            "affiché_TDM": True,
        ...
        },
        {
            ...
            "nom_affiché": "Verbe פ״גּ׳ et ע״ו Modèle עוּד",
            "nom_TDM": "{{nom_affiché}}",
            "ajout_affichage": True,
            "affiché_index": True,
            "affiché_TDM": True,
        ...
        },
        {
            ...
            "nom_affiché": "Verbe פ״גּ׳ et ע״ע Modèle חָלַל",
            "nom_TDM": "{{nom_affiché}}",
            "ajout_affichage": True,
            "affiché_index": True,
            "affiché_TDM": True,
        ...
        },
        {
            ...
            "nom_affiché": "Verbes פ״גּ׳ et ע״ע (avec ע = ר) : les seuls verbes אָרַר ,חָרַר et עָרַר",
            "nom_TDM": "{{nom_affiché}}",
            "ajout_affichage": True,
            "affiché_index": True,
            "affiché_TDM": True,
    ...
    "titre_dossier": "Verbes avec 1<sup>ère</sup> radicale Gutturale (פ״גּ׳)",
    "entete_general": True,
    "pied_general": True,
    "entete": True,
    "pied": True,
