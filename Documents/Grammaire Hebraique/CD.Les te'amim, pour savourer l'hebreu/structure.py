...
STRUCTURE = {
    ...
    "fichiers": [
        ...
        },
        {
            ...
            "nom_affiché": "Commentaires rabbiniques sur Qohèlèt 8:10",
            "nom_TDM": "{{nom_affiché}}",
            "ajout_affichage": True,
            "affiché_index": True,
            "affiché_TDM": True,
        ...
        {
            "nom_document": "Résumé des commentaires rabbiniques sur Qo 810.docx",
            "nom_html": "resume_des_commentaires_rabbiniques_sur_qo_810.pdf",
            "nom_affiché": "Résumé des commentaires rabbiniques sur Qohèlèt 8:10",
            "nom_TDM": "{{nom_affiché}}",
            "ajout_affichage": True,
            "affiché_index": True,
            "affiché_TDM": True,
